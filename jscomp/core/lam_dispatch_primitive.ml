  ...
  begin match prim_name with
    ...
    *)
    ...
    | "caml_sys_const_big_endian" ->
      (** return false *)
      E.js_bool Sys.big_endian
    | "caml_sys_const_word_size" ->
      E.small_int  Sys.word_size
    (** TODO: How it will affect program behavior *)
    | "caml_sys_const_ostype_cygwin" -> E.js_false
    | "caml_sys_const_ostype_win32" -> E.js_false
    | "caml_sys_const_ostype_unix" -> E.js_true
    | "caml_is_js" -> E.js_true
    | "caml_sys_get_config" ->
