...
function new_lex_env(lex_source, lex_lb, enable_types_in_comments) {
  return /* record */[
          ...
          /* lex_lb */lex_lb,
          /* lex_in_comment_syntax : boolean */0,
    ...
    if (__ocaml_lex_state$1 > 77 || __ocaml_lex_state$1 < 0) {
      ...
      switch (__ocaml_lex_state$1) {
        ...
        case 3 : 
            ...
            var env$3 = save_comment(match[0], start, match[1], buf, /* boolean */1);
        ...
        case 4 : 
            ...
            if (env$1[/* lex_enable_comment_syntax */3]) {
              ...
              var env$5 = in_comment_syntax(/* boolean */1, env$4);
              if (escape_type === ":") {
                return /* tuple */[
                        env$5,
                        /* T_COLON */77
              ...
              var env$6 = save_comment(match$1[0], start$1, match$1[1], buf$1, /* boolean */1);
              return token(env$6, lexbuf$1);
            }
        case 5 : 
            if (env$1[/* lex_in_comment_syntax */2]) {
              var env$7 = in_comment_syntax(/* boolean */0, env$1);
        ...
        case 6 : 
            ...
            var env$8 = save_comment(match$2[0], start$2, match$2[1], buf$2, /* boolean */0);
        ...
        case 8 : 
            ...
            var match$4 = string_quote(env$1, quote, buf$3, raw, /* boolean */0, lexbuf$1);
            return /* tuple */[
                    match$4[0],
    ...
    if (__ocaml_lex_state$1 > 5 || __ocaml_lex_state$1 < 0) {
      ...
      switch (__ocaml_lex_state$1) {
        ...
        case 2 : 
            ...
            var env$1 = save_comment(match[0], start, match[1], buf, /* boolean */1);
            ___ocaml_lex_state = 393;
            _env = env$1;
            continue ;
        case 3 : 
            ...
            var env$2 = save_comment(match$1[0], start$1, match$1[1], buf$1, /* boolean */1);
            ___ocaml_lex_state = 393;
            _env = env$2;
            continue ;
        case 4 : 
    ...
    if (__ocaml_lex_state$1 > 48 || __ocaml_lex_state$1 < 0) {
      ...
      switch (__ocaml_lex_state$1) {
        ...
        case 2 : 
            ...
            var buf = $$Buffer.create(127);
            var match = comment(env$1, buf, lexbuf$1);
            var env$2 = save_comment(match[0], start, match[1], buf, /* boolean */1);
        ...
        case 3 : 
            ...
            if (env$1[/* lex_enable_comment_syntax */3]) {
              ...
              var env$4 = in_comment_syntax(/* boolean */1, env$3);
              if (escape_type === ":") {
                return /* tuple */[
                        env$4,
                        /* T_COLON */77
              ...
              $$Buffer.add_string(buf$1, escape_type);
              var match$1 = comment(env$1, buf$1, lexbuf$1);
              var env$5 = save_comment(match$1[0], start$1, match$1[1], buf$1, /* boolean */1);
              return type_token(env$5, lexbuf$1);
            }
        case 4 : 
            if (env$1[/* lex_in_comment_syntax */2]) {
              var env$6 = in_comment_syntax(/* boolean */0, env$1);
        ...
        case 5 : 
            ...
            var buf$2 = $$Buffer.create(127);
            var match$2 = line_comment(env$1, buf$2, lexbuf$1);
            var env$7 = save_comment(match$2[0], start$2, match$2[1], buf$2, /* boolean */1);
        ...
        case 6 : 
            ...
            var raw = $$Buffer.create(127);
            $$Buffer.add_char(raw, quote);
            var match$3 = string_quote(env$1, quote, buf$3, raw, /* boolean */0, lexbuf$1);
            return /* tuple */[
                    match$3[0],
                    /* T_STRING */Block.__(1, [/* tuple */[
...
var default_parse_options = /* record */[
  /* esproposal_class_instance_fields : boolean */0,
  /* esproposal_class_static_fields : boolean */0,
  /* esproposal_decorators : boolean */0,
  /* esproposal_export_star_as : boolean */0,
  /* types : boolean */1,
  /* use_strict : boolean */0
];
...
function init_env($staropt$star, $staropt$star$1, source, content) {
  ...
  return /* record */[
          ...
          /* in_loop : boolean */0,
          /* in_switch : boolean */0,
          /* in_function : boolean */0,
          /* no_in : boolean */0,
          /* no_call : boolean */0,
          /* no_let : boolean */0,
          /* allow_yield : boolean */1,
          /* allow_await : boolean */0,
...
function enter_function(env, async, generator) {
  ...
  newrecord[/* in_loop */7] = /* boolean */0;
  newrecord[/* in_switch */8] = /* boolean */0;
  newrecord[/* in_function */9] = /* boolean */1;
...
function token$3(env) {
  ...
  if (match) {
    ...
    var token$4 = token$2(/* None */0, env);
...
function token$4(env, t) {
  if (Caml_obj.caml_notequal(token$2(/* None */0, env), t)) {
...
function to_parse(env, parse) {
  ...
  try {
    ...
    reset_token_sink(/* boolean */1, env$1, saved_state$1[/* token_buffer */5]);
    ...
    if (exn === Rollback) {
      ...
      reset_token_sink(/* boolean */0, env$2, saved_state$2[/* token_buffer */5]);
...
function with_loc(fn, env) {
  ...
  var match = env[/* last_loc */4][0];
  var end_loc = match ? match[0] : (error$1(env, /* Assertion */Block.__(0, ["did not consume any tokens"])), Curry._2(Parser_env_048[/* loc */2], /* None */0, env));
  return /* tuple */[
...
function primary(env) {
  ...
  if (typeof token$5 === "number") {
    switch (token$5) {
      ...
      case 1 : 
          var match$1 = Curry._2(_object, /* None */0, env);
          return /* tuple */[
                  match$1[0],
          ...
          if (match$2.tag) {
            ...
            return /* tuple */[
                    ...
                    /* Function */Block.__(1, [/* record */[
                          ...
                          /* rest */match$3[0],
                          /* typeParameters : None */0
                        ]])
                  ];
          }
      case 5 : 
          var env$2 = env;
          var start_loc$1 = Curry._2(Parser_env_048[/* loc */2], /* None */0, env$2);
          token$4(env$2, /* T_LBRACKET */5);
          var tl = types(env$2, /* [] */0);
          var end_loc$1 = Curry._2(Parser_env_048[/* loc */2], /* None */0, env$2);
      ...
      case 29 : 
          ...
          break;
      case 44 : 
          var start_loc$2 = Curry._2(Parser_env_048[/* loc */2], /* None */0, env);
      ...
      case 89 : 
          ...
          var typeParameters = Curry._2(type_parameter_declaration, /* boolean */0, env$3);
...
function type_parameter_declaration(allow_default, env) {
  ...
  if (Curry._2(Parser_env_048[/* token */0], /* None */0, env) === /* T_LESS_THAN */89) {
    ...
    token$4(env, /* T_LESS_THAN */89);
    var params$2 = params$1(env, allow_default, /* boolean */0, /* [] */0);
    var loc = btwn(start_loc, Curry._2(Parser_env_048[/* loc */2], /* None */0, env));
    token$4(env, /* T_GREATER_THAN */90);
    return /* Some */[/* tuple */[
              loc,
...
function methodish(env, start_loc) {
  var typeParameters = Curry._2(type_parameter_declaration, /* boolean */0, env);
...
function call_property(env, start_loc, $$static) {
  var value = methodish(env, Curry._2(Parser_env_048[/* loc */2], /* None */0, env));
  return /* tuple */[
...
function _object($staropt$star, env) {
  var allow_static = $staropt$star ? $staropt$star[0] : /* boolean */0;
  var start_loc = Curry._2(Parser_env_048[/* loc */2], /* None */0, env);
...
function identifier(env, _param) {
  while(true) {
    ...
    var q_loc = param[0];
    if (Curry._2(Parser_env_048[/* token */0], /* None */0, env) === /* T_PERIOD */9) {
...
function raw_generic_with_identifier(env, id) {
  ...
  var loc = typeParameters ? btwn(id_loc, typeParameters[0][0]) : id_loc;
  return /* tuple */[
          loc,
          /* record */[
            /* id */match[1],
...
function wrap(f, env) {
  var env$1 = with_strict(/* boolean */1, env);
...
var partial_arg = Curry._1(type_parameter_declaration, /* boolean */1);

function type_parameter_declaration_with_defaults(param) {
  return wrap(partial_arg, param);
}

var partial_arg$1 = Curry._1(type_parameter_declaration, /* boolean */0);
...
function param$1(env) {
  ...
  if (Curry._2(Parser_env_048[/* token */0], /* None */0, env) === /* T_ASSIGN */75) {
...
function param_list(env, _param) {
  while(true) {
    ...
    var t = Curry._2(Parser_env_048[/* token */0], /* None */0, env);
    var exit = 0;
    if (typeof t === "number") {
      var switcher = t - 4 | 0;
      exit = switcher > 7 || switcher < 0 ? (
    ...
    switch (exit) {
      case 1 : 
          ...
          continue ;
      case 2 : 
          var rest = t === /* T_ELLIPSIS */11 ? (token$4(env, /* T_ELLIPSIS */11), /* Some */[Curry._2(Parse[/* identifier_with_type */12], env, /* StrictParamName */28)]) : /* None */0;
          if (Curry._2(Parser_env_048[/* token */0], /* None */0, env) !== /* T_RPAREN */4) {
...
function helper(env, _decls, _errs) {
  while(true) {
    ...
    if (Curry._2(Parser_env_048[/* token */0], /* None */0, env) === /* T_COMMA */8) {
      token$4(env, /* T_COMMA */8);
      _errs = errs$1;
      _decls = decls$1;
      continue ;
...
function $$const(env) {
  var env$1 = with_no_let(/* boolean */1, env);
...
function conditional(env) {
  ...
  if (Curry._2(Parser_env_048[/* token */0], /* None */0, env) === /* T_PLING */76) {
    token$4(env, /* T_PLING */76);
    var env$prime = with_no_in(/* boolean */0, env);
...
function unary(env) {
  var begin_loc = Curry._2(Parser_env_048[/* loc */2], /* None */0, env);
    ...
    if (op$1) {
      ...
      if (Curry._1(Parser_env_048[/* is_line_terminator */5], env$1)) {
        ...
        if (op$2) {
          ...
          var end_loc = Curry._2(Parser_env_048[/* loc */2], /* None */0, env$1);
          token$3(env$1);
          return /* tuple */[
...
function left_hand_side(env) {
  ...
  if (exit === 1) {
    expr = Curry._2(Parser_env_048[/* is_function */9], /* None */0, env) ? _function$1(env) : primary$1(env);
  }
  ...
  while(true) {
    ...
    if (typeof match === "number" && match === 42) {
      ...
      return function finish_fn$prime(callee, args) {
        ...
        return Curry._2(finish_fn, callee$prime, /* None */0);
      }
      }(finish_fn,start_loc));
    ...
    if (exit === 1) {
      ...
      var callee = member(with_no_call(/* boolean */1, env), expr);
      var match$1 = Curry._2(Parser_env_048[/* token */0], /* None */0, env);
      var callee$1;
...
function member(env, left) {
  ...
  if (typeof match === "number") {
    if (match !== 5) {
      ...
      token$4(env, /* T_LBRACKET */5);
      var expr = Curry._1(Parse[/* expression */6], with_no_call(/* boolean */0, env));
      var last_loc = Curry._2(Parser_env_048[/* loc */2], /* None */0, env);
      token$4(env, /* T_RBRACKET */6);
      return call(env, /* tuple */[
...
function _function$1(env) {
  ...
  var generator$1 = generator(env, async$1);
  var match;
  if (Curry._2(Parser_env_048[/* token */0], /* None */0, env) === /* T_LPAREN */3) {
    match = /* tuple */[
      /* None */0,
      /* None */0
    ];
    ...
    var id = typeof match$1 === "number" ? (
      ...
      ) : /* Some */[Curry._2(Parse[/* identifier */10], /* Some */[/* StrictFunctionName */30], env)];
    match = /* tuple */[
      id,
      Curry._1(type_parameter_declaration$1, env)
    ];
  ...
  var expression;
  expression = body.tag ? /* boolean */1 : /* boolean */0;
  return /* tuple */[
...
function number(env, number_type) {
  var value = Curry._2(Parser_env_048[/* value */1], /* None */0, env);
  var value$1;
  if (number_type !== 0) {
    switch (number_type - 1 | 0) {
      case 0 : 
...
function primary$1(env) {
  ...
  if (typeof token$5 === "number") {
    switch (token$5) {
      ...
      case 49 : 
          var loc$1 = Curry._2(Parser_env_048[/* loc */2], /* None */0, env);
      ...
      case 96 : 
          ...
          var loc$2 = Curry._2(Parser_env_048[/* loc */2], /* None */0, env$3);
          var match$4 = Curry._2(Parser_env_048[/* token */0], /* None */0, env$3);
          var match$5;
  ...
  switch (exit) {
    case 1 : 
        if (Curry._2(Parser_env_048[/* is_identifier */8], /* None */0, env)) {
          var id$1 = Curry._2(Parse[/* identifier */10], /* None */0, env);
          return /* tuple */[
                  id$1[0],
...
function try_arrow_function(env) {
  ...
  var env$2 = params === /* [] */0 || rest !== /* None */0 ? without_error_callback(env$1) : env$1;
  if (Curry._1(Parser_env_048[/* is_line_terminator */5], env$2) && Curry._2(Parser_env_048[/* token */0], /* None */0, env$2) === /* T_ARROW */10) {
  ...
  var match$2 = with_loc((function (param) {
          var env = param;
          var async$2 = async$1;
          var generator = /* boolean */0;
          var env$1 = with_in_function(/* boolean */1, env);
          var match = Curry._2(Parser_env_048[/* token */0], /* None */0, env$1);
          var exit = 0;
...
function key(env) {
  ...
  if (typeof match === "number") {
    if (match === 5) {
      var start_loc = Curry._2(Parser_env_048[/* loc */2], /* None */0, env);
      token$4(env, /* T_LBRACKET */5);
      var expr = Curry._1(Parse[/* assignment */7], with_no_in(/* boolean */0, env));
      var end_loc = Curry._2(Parser_env_048[/* loc */2], /* None */0, env);
      token$4(env, /* T_RBRACKET */6);
      return /* tuple */[
              btwn(start_loc, end_loc),
...
function _method(env, kind) {
  var generator$1 = generator(env, /* boolean */0);
  var match = key(env);
  ...
  token$4(env, /* T_RPAREN */4);
  var returnType = wrap(annotation_opt, env);
  var match$1 = function_body(env, /* boolean */0, generator$1);
  var body = match$1[1];
...
function property$1(env) {
  var start_loc = Curry._2(Parser_env_048[/* loc */2], /* None */0, env);
  if (Curry._2(Parser_env_048[/* token */0], /* None */0, env) === /* T_ELLIPSIS */11) {
    token$4(env, /* T_ELLIPSIS */11);
              ...
              case "get" : 
                  ...
                  if (typeof match$2 === "number") {
                    ...
                    tmp = switcher > 74 || switcher < 0 ? (
                        switcher !== 86 ? get(env, start_loc) : init(env, start_loc, key$1, /* boolean */0, /* boolean */0)
                      ) : (
                        switcher > 73 || switcher < 1 ? init(env, start_loc, key$1, /* boolean */0, /* boolean */0) : get(env, start_loc)
                      );
                  } else {
              ...
              case "set" : 
                  ...
                  if (typeof match$3 === "number") {
                    ...
                    tmp = switcher$1 > 74 || switcher$1 < 0 ? (
                        switcher$1 !== 86 ? set(env, start_loc) : init(env, start_loc, key$1, /* boolean */0, /* boolean */0)
                      ) : (
                        switcher$1 > 73 || switcher$1 < 1 ? init(env, start_loc, key$1, /* boolean */0, /* boolean */0) : set(env, start_loc)
                      );
                  } else {
...
function init(env, start_loc, key, async, generator) {
  ...
  switch (exit) {
    ...
    case 3 : 
        ...
        var body = match$3[1];
        var simple = is_simple_function_params(params, defaults, rest);
        strict_post_check(env, match$3[2], simple, /* None */0, params);
        var match$4;
...
function class_implements(env, _acc) {
  while(true) {
    ...
    var loc = typeParameters ? btwn(id[0], typeParameters[0][0]) : id[0];
...
function _class(env) {
  ...
  if (Curry._2(Parser_env_048[/* token */0], /* None */0, env) === /* T_EXTENDS */39) {
    ...
    var superClass = left_hand_side(with_allow_yield(/* boolean */0, env));
...
function class_declaration(env, decorators) {
  ...
  var tmp_env = with_no_let(/* boolean */1, env$1);
...
function class_expression(env) {
  ...
  if (exit === 1) {
    var id = /* Some */[Curry._2(Parse[/* identifier */10], /* None */0, env)];
...
function type_alias_helper(env) {
  ...
  var match = Curry._2(Parser_env_048[/* semicolon_loc */7], /* None */0, env);
  var end_loc = match ? match[0] : right[0];
  semicolon(env);
  pop_lex_mode(env);
  return /* tuple */[
...
function expression(env) {
  ...
  var match = Curry._2(Parser_env_048[/* semicolon_loc */7], /* None */0, env);
  var end_loc = match ? match[0] : expression$1[0];
  semicolon(env);
  return /* tuple */[
...
function declare_function(env, start_loc) {
  token$4(env, /* T_FUNCTION */13);
  var id = Curry._2(Parse[/* identifier */10], /* None */0, env);
  var start_sig_loc = Curry._2(Parser_env_048[/* loc */2], /* None */0, env);
  var typeParameters = Curry._1(type_parameter_declaration$1, env);
  ...
  var match$1 = Curry._2(Parser_env_048[/* semicolon_loc */7], /* None */0, env);
  var end_loc$1 = match$1 ? match$1[0] : end_loc;
  var predicate = Curry._1(Parse[/* predicate */22], env);
  semicolon(env);
...
function declare($staropt$star, env) {
  var in_module = $staropt$star ? $staropt$star[0] : /* boolean */0;
  if (!env[/* parse_options */20][/* types */4]) {
    ...
    if (match >= 22) {
      ...
      if (match !== 0 || Curry._2(Parser_env_048[/* value */1], /* Some */[1], env) !== "module") {
        ...
        if (in_module || Curry._2(Parser_env_048[/* token */0], /* None */0, env) === /* T_PERIOD */9) {
          ...
          var match$2 = Curry._2(Parser_env_048[/* semicolon_loc */7], /* None */0, env$2);
          ...
          var body_end_loc = Curry._2(Parser_env_048[/* loc */2], /* None */0, env$3);
...
function export_specifiers_and_errs(env, _specifiers, _errs) {
  while(true) {
    ...
    if (exit === 1) {
      ...
      var id = match$1[0];
      var match$2;
      if (Curry._2(Parser_env_048[/* value */1], /* None */0, env) === "as") {
        contextual(env, "as");
...
function export_source(env) {
  ...
  if (exit === 1) {
    ...
    var ret_000 = Curry._2(Parser_env_048[/* loc */2], /* None */0, env);
    var ret_001 = /* record */[
      /* value */value$2,
      /* raw */raw$1
    ];
...
function declare_var(env, start_loc) {
  ...
  var match = Curry._2(Parser_env_048[/* semicolon_loc */7], /* None */0, env);
  var end_loc = match ? match[0] : id[0];
  var loc = btwn(start_loc, end_loc);
  semicolon(env);
  return /* tuple */[
          loc,
...
function declare_export_declaration($staropt$star, env) {
  var allow_export_type = $staropt$star ? $staropt$star[0] : /* boolean */0;
  if (!env[/* parse_options */20][/* types */4]) {
    error$1(env, /* UnexpectedTypeDeclaration */7);
  }
  var start_loc = Curry._2(Parser_env_048[/* loc */2], /* None */0, env);
  token$4(env, /* T_DECLARE */58);
  var env$1 = with_in_export(/* boolean */1, with_strict(/* boolean */1, env));
    ...
    if (match >= 52) {
      if (match !== 59) {
        if (match !== 97) {
          ...
          var local_name = Curry._2(Parser_env_048[/* value */1], /* None */0, env$1) === "as" ? (contextual(env$1, "as"), parse_export_star_as ? /* Some */[Curry._2(Parse[/* identifier */10], /* None */0, env$1)] : (error$1(env$1, /* UnexpectedTypeDeclaration */7), /* None */0)) : /* None */0;
      ...
      switch (match - 13 | 0) {
        case 21 : 
            ...
            var match$4 = Curry._2(Parser_env_048[/* token */0], /* None */0, env$1);
            var match$5;
            var exit$1 = 0;
            if (typeof match$4 === "number") {
              if (match$4 !== 13) {
            ...
            if (exit$1 === 3) {
              ...
              var match$6 = Curry._2(Parser_env_048[/* semicolon_loc */7], /* None */0, env$1);
  ...
  switch (exit) {
    case 1 : 
        var match$7 = Curry._2(Parser_env_048[/* token */0], /* None */0, env$1);
    ...
    case 2 : 
        var token$5 = Curry._2(Parser_env_048[/* token */0], /* None */0, env$1);
        var match$10;
        var exit$2 = 0;
        if (typeof token$5 === "number") {
          if (token$5 >= 23) {
...
function interface_helper(env) {
  ...
  var body = _object$1(/* Some */[/* boolean */1], env);
  var loc = btwn(start_loc, body[0]);
  return /* tuple */[
          loc,
          /* record */[
...
function declare_class(env, start_loc) {
  ...
  var body = _object$1(/* Some */[/* boolean */1], env$1);
  var loc = btwn(start_loc, body[0]);
  return /* tuple */[
          loc,
          /* record */[
...
function module_items(env, _module_kind, _acc) {
  while(true) {
    ...
    if (exit === 1) {
      var stmt = declare(/* Some */[/* boolean */1], env);
      var stmt$1 = stmt[1];
      var loc = stmt[0];
      var module_kind$1;
      if (module_kind) {
...
function _if(env) {
  ...
  token$4(env, /* T_RPAREN */4);
  Curry._2(Parser_env_048[/* token */0], /* None */0, env);
  var consequent = Curry._2(Parser_env_048[/* is_function */9], /* None */0, env) ? (strict_error(env, /* StrictFunctionStatement */45), _function(env)) : Curry._1(Parse[/* statement */1], env);
  var alternate = Curry._2(Parser_env_048[/* token */0], /* None */0, env) === /* T_ELSE */41 ? (token$4(env, /* T_ELSE */41), /* Some */[Curry._1(Parse[/* statement */1], env)]) : /* None */0;
...
function case_list(env, _param) {
  while(true) {
    ...
    if (exit === 1) {
      ...
      var consequent = Curry._2(Parse[/* statement_list */3], term_fn, with_in_switch(/* boolean */1, env));
...
function specifier_list(env, _acc) {
  while(true) {
    ...
    if (exit === 1) {
      ...
      if (Curry._2(Parser_env_048[/* value */1], /* None */0, env) === "as") {
        contextual(env, "as");
        var local = /* Some */[Curry._2(Parse[/* identifier */10], /* None */0, env)];
...
function _object$2(restricted_error) {
  var property = function (env) {
    ...
    if (maybe(env, /* T_ELLIPSIS */11)) {
      ...
      var loc = btwn(start_loc, argument[0]);
      return /* Some */[/* SpreadProperty */Block.__(1, [/* tuple */[
                    loc,
                    /* record */[/* argument */argument]
                  ]])];
    } else {
...
function identifier$1(env) {
  var loc = Curry._2(Parser_env_048[/* loc */2], /* None */0, env);
  var name = Curry._2(Parser_env_048[/* value */1], /* None */0, env);
...
function attribute(env) {
  ...
  if (Curry._2(Parser_env_048[/* token */0], /* None */0, env) === /* T_ASSIGN */75) {
    ...
    if (exit === 1) {
      ...
      var loc$3 = Curry._2(Parser_env_048[/* loc */2], /* None */0, env);
      match$1 = /* tuple */[
        loc$3,
        /* Some */[/* Literal */Block.__(0, [
              loc$3,
    ...
    if (switcher > 11 || switcher < 0) {
      ...
      switch (switcher) {
        case 0 : 
            var env$1 = env;
            var decorators$1 = decorators;
            var env$2 = with_in_export(/* boolean */1, with_strict(/* boolean */1, env$1));
            ...
            if (typeof match$1 === "number") {
              if (match$1 >= 51) {
                if (match$1 !== 97) {
                  ...
                  var local_name = Curry._2(Parser_env_048[/* value */1], /* None */0, env$2) === "as" ? (contextual(env$2, "as"), parse_export_star_as ? /* Some */[Curry._2(Parse[/* identifier */10], /* None */0, env$2)] : (error$1(env$2, /* UnexpectedTypeDeclaration */7), /* None */0)) : /* None */0;
                  var specifiers = /* Some */[/* ExportBatchSpecifier */Block.__(1, [
                        loc,
                        local_name
                      ])];
                ...
                if (switcher$1 > 26 || switcher$1 < 0) {
                  ...
                  switch (switcher$1) {
                    case 22 : 
                        ...
                        record_export(env$2, /* tuple */[
                              btwn(start_loc, Curry._2(Parser_env_048[/* loc */2], /* None */0, env$2)),
                              "default"
                            ]);
                        var match$5 = Curry._2(Parser_env_048[/* token */0], /* None */0, env$2);
                        var match$6;
                        var exit$1 = 0;
                        ...
                        if (exit$1 === 3) {
                          if (Curry._2(Parser_env_048[/* is_class */10], /* None */0, env$2)) {
                            ...
                            match$6 = /* tuple */[
                              end_loc$3,
                              /* Some */[/* Expression */Block.__(1, [expr])]
                            ];
                          }
                        }
                        return /* tuple */[
            ...
            switch (exit) {
              case 1 : 
                  var match$8 = Curry._2(Parser_env_048[/* token */0], /* None */0, env$2);
        ...
        case 1 : 
            ...
            var env$3 = env;
            var env$4 = with_strict(/* boolean */1, env$3);
            ...
            var match$16 = Curry._2(Parser_env_048[/* token */0], /* None */0, env$4);
            var match$17 = Curry._2(Parser_env_048[/* is_identifier */8], /* None */0, env$4);
            var exit$2 = 0;
            var exit$3 = 0;
            ...
            if (exit$2 === 1) {
              var match$21 = Curry._2(Parser_env_048[/* token */0], /* None */0, env$4);
              ...
              if (exit$4 === 2) {
                match$23 = /* tuple */[
                  importKind,
                  /* ImportDefaultSpecifier */Block.__(1, [Curry._2(Parse[/* identifier */10], /* None */0, env$4)])
                ];
              }
              var match$24 = Curry._2(Parser_env_048[/* token */0], /* None */0, env$4);
              ...
              var match$25 = Curry._2(Parser_env_048[/* semicolon_loc */7], /* None */0, env$4);
  ...
  while(true) {
        ...
        if (match >= 58) {
          ...
          switch (match) {
            ...
            case 17 : 
                ...
                var argument = Curry._2(Parser_env_048[/* token */0], /* None */0, env$3) === /* T_SEMICOLON */7 || Curry._1(Parser_env_048[/* is_implicit_semicolon */6], env$3) ? /* None */0 : /* Some */[Curry._1(Parse[/* expression */6], env$3)];
                var match$2 = Curry._2(Parser_env_048[/* semicolon_loc */7], /* None */0, env$3);
            ...
            case 20 : 
                var env$5 = env;
                var start_loc$2 = Curry._2(Parser_env_048[/* loc */2], /* None */0, env$5);
                ...
                var match$3 = Curry._2(Parser_env_048[/* semicolon_loc */7], /* None */0, env$5);
            ...
            case 21 : 
                var env$6 = env;
                var start_loc$3 = Curry._2(Parser_env_048[/* loc */2], /* None */0, env$6);
                token$4(env$6, /* T_TRY */21);
                var block = Curry._1(Parse[/* block_body */13], env$6);
                var match$4 = Curry._2(Parser_env_048[/* token */0], /* None */0, env$6);
                var handler;
                ...
                var end_loc$3 = finalizer ? finalizer[0][0] : (
                    handler ? handler[0][0] : (error_at(env$6, /* tuple */[
                              block[0],
                              /* NoCatchOrFinally */20
                            ]), block[0])
                  );
            ...
            case 23 : 
                var env$7 = env;
                var start_loc$5 = Curry._2(Parser_env_048[/* loc */2], /* None */0, env$7);
                token$4(env$7, /* T_WHILE */23);
                token$4(env$7, /* T_LPAREN */3);
                var test = Curry._1(Parse[/* expression */6], env$7);
                token$4(env$7, /* T_RPAREN */4);
                var body$1 = Curry._1(Parse[/* statement */1], with_in_loop(/* boolean */1, env$7));
                return /* tuple */[
            ...
            case 24 : 
                var env$8 = env;
                var start_loc$6 = Curry._2(Parser_env_048[/* loc */2], /* None */0, env$8);
            ...
            case 30 : 
                var env$9 = env;
                var start_loc$7 = Curry._2(Parser_env_048[/* loc */2], /* None */0, env$9);
                ...
                var match$6 = Curry._2(Parser_env_048[/* semicolon_loc */7], /* None */0, env$9);
            ...
            case 33 : 
                var env$10 = env;
                var start_loc$8 = Curry._2(Parser_env_048[/* loc */2], /* None */0, env$10);
            ...
            case 35 : 
                ...
                var body$3 = Curry._1(Parse[/* statement */1], with_in_loop(/* boolean */1, env$11));
                token$4(env$11, /* T_WHILE */23);
                token$4(env$11, /* T_LPAREN */3);
                var test$1 = Curry._1(Parse[/* expression */6], env$11);
                var end_loc$6 = Curry._2(Parser_env_048[/* loc */2], /* None */0, env$11);
                token$4(env$11, /* T_RPAREN */4);
                var match$8 = Curry._2(Parser_env_048[/* semicolon_loc */7], /* None */0, env$11);
                var end_loc$7 = match$8 ? match$8[0] : end_loc$6;
                if (Curry._2(Parser_env_048[/* token */0], /* None */0, env$11) === /* T_SEMICOLON */7) {
                  semicolon(env$11);
                }
                return /* tuple */[
            ...
            case 37 : 
                var env$12 = env;
                var start_loc$10 = Curry._2(Parser_env_048[/* loc */2], /* None */0, env$12);
                token$4(env$12, /* T_FOR */37);
                token$4(env$12, /* T_LPAREN */3);
                var match$9 = Curry._2(Parser_env_048[/* token */0], /* None */0, env$12);
                var match$10;
                var exit$2 = 0;
                if (typeof match$9 === "number") {
                  if (match$9 >= 22) {
                    if (match$9 >= 27) {
                      ...
                      switch (match$9 - 22 | 0) {
                        case 0 : 
                            var match$11 = declarations(/* T_VAR */22, /* Var */0, with_no_in(/* boolean */1, env$12));
                            match$10 = /* tuple */[
                        ...
                        case 2 : 
                            ...
                            break;
                        case 3 : 
                            var match$12 = $$const(with_no_in(/* boolean */1, env$12));
                            match$10 = /* tuple */[
                            ...
                            break;
                        case 4 : 
                            var match$13 = _let(with_no_in(/* boolean */1, env$12));
                            match$10 = /* tuple */[
                ...
                if (exit$2 === 1) {
                  var expr = Curry._1(Parse[/* expression */6], with_no_let(/* boolean */1, with_no_in(/* boolean */1, env$12)));
                  match$10 = /* tuple */[
                ...
                var init = match$10[0];
                var match$14 = Curry._2(Parser_env_048[/* token */0], /* None */0, env$12);
                var exit$3 = 0;
                if (typeof match$14 === "number") {
                  if (match$14 !== 15) {
                    if (match$14 !== 60) {
                      ...
                      var body$4 = Curry._1(Parse[/* statement */1], with_in_loop(/* boolean */1, env$12));
                      return /* tuple */[
                    ...
                    token$4(env$12, /* T_RPAREN */4);
                    var body$5 = Curry._1(Parse[/* statement */1], with_in_loop(/* boolean */1, env$12));
                    return /* tuple */[
                ...
                if (exit$3 === 1) {
                  ...
                  var match$17 = Curry._2(Parser_env_048[/* token */0], /* None */0, env$12);
                  var test$2 = typeof match$17 === "number" ? (
                      match$17 !== 7 ? /* Some */[Curry._1(Parse[/* expression */6], env$12)] : /* None */0
                    ) : /* Some */[Curry._1(Parse[/* expression */6], env$12)];
                  token$4(env$12, /* T_SEMICOLON */7);
                  var match$18 = Curry._2(Parser_env_048[/* token */0], /* None */0, env$12);
                  var update = typeof match$18 === "number" ? (
                      match$18 !== 4 ? /* Some */[Curry._1(Parse[/* expression */6], env$12)] : /* None */0
                    ) : /* Some */[Curry._1(Parse[/* expression */6], env$12)];
                  token$4(env$12, /* T_RPAREN */4);
                  var body$6 = Curry._1(Parse[/* statement */1], with_in_loop(/* boolean */1, env$12));
                  return /* tuple */[
            ...
            case 57 : 
                var env$13 = env;
                var start_loc$11 = Curry._2(Parser_env_048[/* loc */2], /* None */0, env$13);
                token$4(env$13, /* T_DEBUGGER */57);
                var match$19 = Curry._2(Parser_env_048[/* semicolon_loc */7], /* None */0, env$13);
                var end_loc$8 = match$19 ? match$19[0] : start_loc$11;
                semicolon(env$13);
                return /* tuple */[
    ...
    if (exit$1 === 2) {
      if (Curry._2(Parser_env_048[/* is_identifier */8], /* None */0, env)) {
        ...
        var match$20 = Curry._2(Parser_env_048[/* token */0], /* None */0, env$14);
        ...
        if (exit$4 === 1) {
          ...
          var end_loc$9 = match$23 ? match$23[0] : expr$1[0];
          semicolon(env$14);
          return /* tuple */[
    ...
    if (match !== 25) {
      if (match !== 26) {
        ...
        if (Curry._2(Parser_env_048[/* token */0], /* None */0, env$1) === /* T_LPAREN */3) {
          ...
          var match$1 = helper(with_no_let(/* boolean */1, env$1), /* [] */0, /* [] */0);
          ...
          var match$3 = helper(with_no_let(/* boolean */1, env$1), /* [] */0, /* [] */0);
...
function identifier_with_type(env, restricted_error) {
  ...
  if (Curry._2(Parser_env_048[/* token */0], /* None */0, env) === /* T_COLON */77) {
    ...
    var typeAnnotation$1 = /* Some */[typeAnnotation];
    return /* tuple */[
            loc$3,
            /* record */[
              /* name */id$1[/* name */0],
...
function program$1($staropt$star, $staropt$star$1, $staropt$star$2, content) {
  var fail = $staropt$star ? $staropt$star[0] : /* boolean */1;
  var token_sink = $staropt$star$1 ? $staropt$star$1[0] : /* None */0;
  var parse_options = $staropt$star$2 ? $staropt$star$2[0] : /* None */0;
  var fail$1 = fail;
  var $staropt$star$3 = /* Some */[token_sink];
  var $staropt$star$4 = /* Some */[parse_options];
  var filename = /* None */0;
  var content$1 = content;
  var token_sink$1 = $staropt$star$3 ? $staropt$star$3[0] : /* None */0;
  var parse_options$1 = $staropt$star$4 ? $staropt$star$4[0] : /* None */0;
  var env = init_env(/* Some */[token_sink$1], /* Some */[parse_options$1], filename, content$1);
  var env$1 = env;
...
function parse(content, _) {
  try {
    var match = program$1(/* Some */[/* boolean */0], /* None */0, /* Some */[/* None */0], content);
