...
function binary(stk, lvl) {
  if (lvl === -1) {
    ...
    if (lvl < 8) {
      ...
      var loc = foldtst(0);
      return patch(/* boolean */1, loc, opos[0]);
    }
  }
}
...
function stmt(brk, stk) {
  ...
  if (Caml_obj.caml_equal(t, tokif)) {
    ...
    if (nextis(tokelse)) {
      ...
      var l = opos[0];
      le(32, 0);
      patch(/* boolean */1, loc, opos[0]);
      stmt(brk, stk);
      loc$1 = l;
    } else {
      loc$1 = loc;
    }
    return patch(/* boolean */1, loc$1, opos[0]);
    ...
    patch(/* boolean */1, match[0], opos[0]);
    stmt(/* tuple */[
          bl,
          ba
        ], stk);
    ...
    return patch(/* boolean */1, bl[0], opos[0]);
...
function block(brk, stk) {
  var match = decl(/* boolean */0, 0, stk);
...
function elfgen(outf) {
  ...
  var patchloc = function (i, _) {
    ...
    if (g[/* va */1] >= 0 && g[/* va */1] < 4194304) {
      return patch(/* boolean */0, g[/* loc */0], va(g[/* va */1]));
    } else if (g[/* va */1] >= 0) {
      return patch(/* boolean */0, g[/* loc */0], g[/* va */1]);
    } else {
      return 0;
    }
  };
