...
function mapOfArray(x) {
  return Belt_Map.ofArray(x, Icmp);
}
...
var u0 = Belt_Map.ofArray(x, Icmp);

var x$1 = randomRange(30, 120);

var u1 = Belt_Map.ofArray(x$1, Icmp);

var x$2 = Array_data_util.range(30, 100);

b("File \"bs_poly_map_test.ml\", line 48, characters 4-11", Belt_Set.eq(mergeInter(u0, u1), Belt_Set.ofArray(x$2, Icmp)));

var x$3 = Array_data_util.range(0, 120);

b("File \"bs_poly_map_test.ml\", line 49, characters 4-11", Belt_Set.eq(mergeUnion(u0, u1), Belt_Set.ofArray(x$3, Icmp)));

var x$4 = Array_data_util.range(0, 29);

b("File \"bs_poly_map_test.ml\", line 50, characters 4-11", Belt_Set.eq(mergeDiff(u0, u1), Belt_Set.ofArray(x$4, Icmp)));

var x$5 = Array_data_util.range(101, 120);

b("File \"bs_poly_map_test.ml\", line 51, characters 4-11", Belt_Set.eq(mergeDiff(u1, u0), Belt_Set.ofArray(x$5, Icmp)));

var x$6 = randomRange(0, 10);

var a0 = Belt_Map.ofArray(x$6, Icmp);
...
var u0$1 = Belt_Map.ofArray(x$7, Icmp);
